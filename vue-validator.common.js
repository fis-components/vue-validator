...
function Validate (Vue) {
  ...
  Vue.directive('validate', {
    ...
    bind: function bind() {
      ...
      if ("production" !== 'production' && el.__vue__) {
        warn('v-validate="' + this.expression + '" cannot be ' + 'used on an instance root element.');
        this._invalid = true;
        return;
      }

      if ("production" !== 'production' && (el.hasAttribute('v-if') || el.hasAttribute('v-for'))) {
      ...
      if ("production" !== 'production' && !(this.arg || this.params.field)) {
      ...
      if ("production" !== 'production' && !validatorName) {
...
function Validator (Vue) {
  ...
  Vue.elementDirective('validator', {
    ...
    bind: function bind() {
      ...
      if ("production" !== 'production' && !params.name) {
